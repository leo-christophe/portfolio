    ...
    <span id="navContent">
      <span id="headerTitle">
        <a href="/" id="headerHomeLink">
          <img
            src="/images/app_identity/icon.webp"
            alt="Logo"
            title="Léo Christophe Logo"
            id="headerLogo"
          />
          <p>Léo Christophe</p>
        </a>
      ...
      <div id="buttonTranslateContainer" class="buttonTranslateContainer">
        <button
          id="buttonTranslate"
          :title="$t('header.translateHeaderDesc')"
          @click="switchPageLang()"
        >
          <i
            id="buttonTranslateIcon"
            class="pi pi-language"
            style="font-size: var(--IconSize)"
          ></i>
        </button>
      </div>
    </span>
