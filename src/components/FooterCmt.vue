  ...
  <footer>
    <ul>
      <li class="footerURLLink">
        <RouterLink
          class="footerURLLink"
          :style="{ color: COULEUR_MENU_SELECTIONNE }"
          to="/mesdonnees"
          >{{ $t("pages.personalData") }}</RouterLink
        >
      </li>
      <li class="footerURLLink">
        <RouterLink
          ...
          :style="{ color: COULEUR_MENU_SELECTIONNE }"
          to="/contact"
          >{{ $t("pages.contactInfo") }}</RouterLink
        >
      </li>
      <li class="footerURLLink">
        <a
    ...
    <p id="watermark">
      <strong>© {{ new Date().getFullYear() }} {{ $t("footer.name") }}</strong>
    </p>
