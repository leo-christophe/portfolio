    ...
    <div class="skills-display">
        ...
        <span>
          ...
          >
            ...
            <div class="hard-skills">
              <div
                v-for="(percentage, skillName, index) in main_hard_skills"
                :key="index"
                ...
                <div class="skill-content">
                  ...
                  >
                    <template #item="slotProps">
                      ...
                      >
                        <img
                          :src="'/images/icons/tech/' + slotProps.data.image"
          ...
          <span v-else id="hardSkillsContainer" class="skillsContainer">
            ...
            <div id="skillsGrid">
              ...
              >
                <div
                  v-for="(skill, index1) in hardSkillsImages[index]"
                  :key="index1"
                  @click="
                    router.push({
                      path: '/skillslist',
                      query: {
                        skill:
                          skill === 'CSharp'
                            ? 'C#'
                            : skill.replace('.svg', '').replace('.webp', ''),
                      },
                    })
                  "
                >
                  <img
                    :src="
                      '/images/icons/tech/' + hardSkillsImages[index][index1]
                    "
                    :alt="skillName"
      ...
      <section class="sectionPage">
        <div id="referenceTitle">
          <h1 class="references-title sectionTitle">
            {{ $t("skills.references") }}
          </h1>
        </div>
                ...
                <template #item="slotProps">
                  <div class="reference-card">
                    <div class="reference-image-container">
                      <img
                        :src="'/images/icons/' + slotProps.data.image"
                        :alt="slotProps.data.name"
                    ...
                    <div class="reference-content">
                      ...
                      <div class="reference-details">
                        ...
                        <em>{{ slotProps.data.occupation }}</em>
                        {{ $t("words.at") }} {{ slotProps.data.enterprise
                        }}<br />
                        ...
                        <span id="contactRef">
                          ...
                          <span v-if="slotProps.data.phone"
                            ><i class="pi pi-phone" />
                            {{ slotProps.data.phone }}</span
                          >
                        </span>
                      </div>
                    </div>
