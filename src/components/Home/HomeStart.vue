...
const CVAdress = document.querySelector(
  "#app > div > footer > ul > li:nth-child(3) > a",
).href;

const imgProfilLoaded = ref(false);
</script>
      ...
      <div id="textAndButtons">
        <div id="textAndPhoto">
            ...
            <div id="CTAButtons" class="paragraphe">
              ...
              >
                <Button id="blackVariant"
                  >{{ $t("home.viewCV") + " " }}
                  <i class="pi pi-chevron-right chevronDroitBoutonsDroits"></i
                ></Button>
              </a>
          ...
          <span id="photoContainer" class="border-animated-box">
            ...
            <img
              src="/images/app_identity/photo.webp"
              alt="Léo Christophe Photo"
              :title="$t('home.profilePicture')"
              id="photoProfil"
              @load="imgProfilLoaded = true"
            />
          </span>
        </div>
      </div>
