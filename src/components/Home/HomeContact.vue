    ...
    <div id="textCV">
      <div id="mainText">
        ...
        <span>
          ...
          <div id="SousTitre">
            {{ $t("home.contactSection.homeContactDesc") }}
          </div>

          <div id="finalText" class="CVsection computer">
            <h2>
              {{ $t("home.contactSection.CTA1")
              }}<RouterLink to="/contact">{{
                $t("home.contactSection.CTA2")
              }}</RouterLink
              >{{ $t("home.contactSection.CTA3") }}
            </h2>
          </div>
          ...
          <span id="buttons">
            <Button id="blackVariant" @click="downloadCV">
              ...
              >{{ $t("home.contactSection.btnDownload") }}
            </Button>
            <Button id="blackVariant" @click="consultCV">
              <i class="pi pi-eye"></i
              >{{ $t("home.contactSection.btnConsult") }}
            </Button>
          </span>
        </span>
      </div>
