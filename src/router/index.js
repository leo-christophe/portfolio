...
const routes = [
    ...
    { path: '/confidentialite', name: 'Confidentialité', component: () => import('../views/confidentialite.vue') },
    { path: '/:pathMatch(.*)*', name: 'NotFound', component: () => import('../components/Error/NotFound.vue') }
  ];
